    ...
    return (
        <>
            ...
            <section className="">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-6xl mx-auto justify-items-center">
                    <ExploreCard src={exp1} mainText="hostel hustlers" subText="Try out these  tasty and easy dishes which will satisfy your cravings" />
                    <ExploreCard src={exp2} mainText="mid night cravings" subText="Try out these  tasty and easy dishes which will satisfy your cravings" />
                    <ExploreCard src={exp3} mainText="what for dinner?" subText="Try out these  tasty and easy dishes which will satisfy your cravings" />
                    <ExploreCard src={exp4} mainText="all time favorite-easy snacks" subText="Try out these  tasty and easy dishes which will satisfy your cravings" />
                </div>
